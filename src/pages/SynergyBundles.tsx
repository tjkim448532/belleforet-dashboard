...
export default function SynergyBundles() {
  ...
  // SSOT Simulation Fallback Bundle Data
  const defaultBundles: CustomerBundleItem[] = useMemo(() => [
    {
      bundleKey: 'ROOM_GOLF_NAMDO',
      bundleName: '[숙박 + 벨포레CC 골프 + 남도예담]',
      categoryType: 'GOLF_INCLUDED',
      storeList: ['콘도 객실', '벨포레CC (골프)', '남도예담 (한정식)'],
      customerCount: 124,
      ratioPct: 4.4,
      totalSales: 89280000,
      avgSpendPerCustomer: 720000,
      badgeColor: 'border-emerald-200 bg-emerald-50/60 text-emerald-900'
    },
    {
      bundleKey: 'ROOM_SUMMER_TWOSOME',
      bundleName: '[숙박 + 썸머랜드 + 투썸플레이스]',
      categoryType: 'ROOM_INCLUDED',
      storeList: ['콘도 객실', '썸머랜드 (워터파크)', '투썸플레이스'],
      customerCount: 684,
      ratioPct: 24.1,
      totalSales: 143640000,
      avgSpendPerCustomer: 210000,
      badgeColor: 'border-purple-200 bg-purple-50/60 text-purple-900'
    },
    {
      bundleKey: 'ROOM_MEDIA',
      bundleName: '[숙박 + 미디어아트센터]',
      categoryType: 'ROOM_INCLUDED',
      storeList: ['콘도 객실', '미디어아트센터'],
      customerCount: 312,
      ratioPct: 11.0,
      totalSales: 74880000,
      avgSpendPerCustomer: 240000,
      badgeColor: 'border-indigo-200 bg-indigo-50/60 text-indigo-900'
    },
    {
      bundleKey: 'ROOM_MOTO_CUCINA',
      bundleName: '[숙박 + 모토아레나 + 쿠치나]',
      categoryType: 'ROOM_INCLUDED',
      storeList: ['콘도 객실', '모토아레나 (카트)', '쿠치나 (식음)'],
      customerCount: 185,
      ratioPct: 6.5,
      totalSales: 59200000,
      avgSpendPerCustomer: 320000,
      badgeColor: 'border-amber-200 bg-amber-50/60 text-amber-900'
    },
    {
      bundleKey: 'GOLF_MINARI_DAY',
      bundleName: '[벨포레CC 골프 + 미나리생삼겹] (비투숙)',
      categoryType: 'DAY_VISIT',
      storeList: ['벨포레CC (골프)', '미나리생삼겹'],
      customerCount: 142,
      ratioPct: 5.0,
      totalSales: 49700000,
      avgSpendPerCustomer: 350000,
      badgeColor: 'border-teal-200 bg-teal-50/60 text-teal-900'
    },
    {
      bundleKey: 'ROOM_RANCH_BAKERY',
      bundleName: '[숙박 + 목장체험 + 벨포레베이커리]',
      categoryType: 'ROOM_INCLUDED',
      storeList: ['콘도 객실', '벨포레 목장', '벨포레 베이커리'],
      customerCount: 435,
      ratioPct: 15.3,
      totalSales: 82650000,
      avgSpendPerCustomer: 190000,
      badgeColor: 'border-rose-200 bg-rose-50/60 text-rose-900'
    },
    {
      bundleKey: 'FNB_ONLY_COMBO',
      bundleName: '[남도예담 + 얼룩말카페] (당일 식음)',
      categoryType: 'FNB_ONLY',
      storeList: ['남도예담', '얼룩말카페'],
      customerCount: 278,
      ratioPct: 9.8,
      totalSales: 22240000,
      avgSpendPerCustomer: 80000,
      badgeColor: 'border-orange-200 bg-orange-50/60 text-orange-900'
    },
    {
      bundleKey: 'ROOM_SINGLE_ONLY',
      bundleName: '[콘도 숙박 단독 이용 (부대시설 미이용)]',
      categoryType: 'ROOM_INCLUDED',
      storeList: ['콘도 객실 단독'],
      customerCount: 480,
      ratioPct: 16.9,
      totalSales: 81600000,
      avgSpendPerCustomer: 170000,
      badgeColor: 'border-slate-200 bg-slate-100/60 text-slate-800'
    }
  ], []);
